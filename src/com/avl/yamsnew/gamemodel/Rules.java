...
public class Rules {
	...
	public static void checkRoll(Game game, int[] indexOfDicesToRoll, ScoreGrid scoreGrid) throws Exception {
		...
		if (game.getCurrentDiceRoll() == 3) {
			throw new Exception("You can't play more than three times");
		}
		else if (game.getCurrentDiceRoll() == 0 
